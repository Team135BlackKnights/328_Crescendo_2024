...
public final class Constants {
    ...
    public static final int hangMotorID1 = 40;
    public static final int hangMotorID2 = 41;
    public static final int tensionMotorID1 = 50;
    public static final int tensionMotorID2 = 51;
