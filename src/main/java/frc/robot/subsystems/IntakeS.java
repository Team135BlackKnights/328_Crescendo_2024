...
public class IntakeS extends SubsystemBase { //create a subsystem
    ...
    public static CANSparkMax intakeMotor = new CANSparkMax(Constants.Intake_ID,MotorType.kBrushless);
    public static CANSparkMax intakeMotor2 = new CANSparkMax(Constants.Intake_ID2,MotorType.kBrushless);
